 ...
 */
SuperMap.LevelRenderer.Shape = SuperMap.Class(SuperMap.LevelRenderer.Eventful, SuperMap.LevelRenderer.Transformable, {
    ...
    destroy: function() {
        ...
        SuperMap.LevelRenderer.Transformable.prototype.destroy.apply(this, arguments);
     ...
     * {Object} 处理后的样式。
     */
    beforeBrush: function(ctx, isHighlight){
     ...
     *
     */
    getHighlightStyle: function(style, highlightStyle, brushTypeOnly){
        var newStyle = {};
        for (var k in style) {
            newStyle[k] = style[k];
        }
     ...
     */
    drawText: function(ctx, style, normalStyle){
     ...
     */
    setCtxGlobalAlpha: function(_ctx, type, style) {
        if (type === "fill") {
 ...
 * 填充文本
 */
SuperMap.LevelRenderer.Shape._fillText = function(ctx, text, x, y, textFont, textAlign, textBaseline) {
    if (textFont) {
        ctx.font = textFont;
    }
 ...
 * {Object} 矩形区域。
 */
SuperMap.LevelRenderer.Shape._getTextRect = function(text, x, y, textFont, textAlign, textBaseline) {
