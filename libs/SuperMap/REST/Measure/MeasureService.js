...
SuperMap.REST.MeasureService = SuperMap.Class(SuperMap.ServiceBase, {
    ...
    processAsync: function(params) {
        ...
        var prjCoordSysTemp,prjCodeTemp,paramsTemp,distanceMode = params.distanceMode;
        if(params.prjCoordSys){
            ...
            paramsTemp = {"point2Ds": SuperMap.Util.toJSON(point2ds), "unit": params.unit, "prjCoordSys":prjCoordSysTemp,distanceMode:distanceMode};
        }
        else
        {
            paramsTemp = {"point2Ds": SuperMap.Util.toJSON(point2ds), "unit": params.unit,distanceMode:distanceMode};
        }
