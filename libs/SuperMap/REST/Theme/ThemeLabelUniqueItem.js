...
/**
 * Class: SuperMap.REST.ThemeLabelUniqueItem
 * 单值标签专题图的子项。
 ...
 */
SuperMap.REST.ThemeLabelUniqueItem = SuperMap.Class({
    ...
    /**
     * Constructor: SuperMap.REST.ThemeLabelUniqueItem 
    ...
    CLASS_NAME: "SuperMap.REST.ThemeLabelUniqueItem"
});
SuperMap.REST.ThemeLabelUniqueItem.fromObj = function(obj) {
    if(!obj) return;
    var t = new SuperMap.REST.ThemeLabelUniqueItem();
