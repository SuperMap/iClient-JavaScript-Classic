...
test("testGeoText_getLabelPxSize",function(){
    ...
    equals(size1.w,33,"Property:w");
    equals(size1.h,21,"Property:h");
    equals(size2.w,33,"Property:w");
...
test("testGeoText_getLabelPxBoundsByText",function(){
    ...
    equals(labelPxBounds1.left,10,"Property:Left");
    equals(labelPxBounds1.top,10,"Property:Top");
    equals(labelPxBounds1.right,43,"Property:Right");
    ...
    equals(labelPxBounds2.right,43,"Property:Right");
    ...
    equals(labelPxBounds8.left,-23,"Property:Left");
    ...
    equals(labelPxBounds9.left,-23,"Property:Left");
