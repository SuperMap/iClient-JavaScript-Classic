...
test("testGOAnimationManager_Constructor", function () {
    expect(1);
    var goAnimationManager=new SuperMap.Plot.GOAnimationManager();
    equal(goAnimationManager.CLASS_NAME, "SuperMap.Plot.GOAnimationManager", "function:CLASS_NAME");
});

asyncTest("testGOAnimationManager_Destroy", function () {
    ...
    setTimeout(function () {
        try{
            ...
            goAnimationManager.createGOAnimation(SuperMap.Plot.GOAnimationType.ANIMATION_SHOW,"显隐动画",dotSymbol);
            goAnimationManager.destroy();
            equal(goAnimationManager.goAnimations, null, "function:goAnimations");
...
test("testGOAnimationManager_setMap", function () {
    expect(1);
    var goAnimationManager=new SuperMap.Plot.GOAnimationManager();
...
asyncTest("testGOAnimationManager_createGOAnimation", function () {
    var libID = 421, code2 = 10200, locationPoints = [new SuperMap.Geometry.Point(20, 30)];
    var map, layer, plottingLayer, dotSymbol;
    map = new SuperMap.Map("map");
    layer = new SuperMap.Layer.TiledDynamicRESTLayer("World", GlobeParameter.WorldURL, null, {maxResolution: "auto"});
    ...
    setTimeout(function () {
        try{
            var goAnimationManager=new SuperMap.Plot.GOAnimationManager();
            goAnimationManager.setMap(map);
            var goAnimation=goAnimationManager.createGOAnimation(SuperMap.Plot.GOAnimationType.ANIMATION_SHOW,"显隐动画",dotSymbol);
...
asyncTest("testGOAnimationManager_findGOAnimationByName", function () {
    var libID = 421, code2 = 10200, locationPoints = [new SuperMap.Geometry.Point(20, 30)];
    var map, layer, plottingLayer, dotSymbol;
    map = new SuperMap.Map("map");
    layer = new SuperMap.Layer.TiledDynamicRESTLayer("World", GlobeParameter.WorldURL, null, {maxResolution: "auto"});
    ...
    setTimeout(function () {
        try{
            var goAnimationManager=new SuperMap.Plot.GOAnimationManager();
            goAnimationManager.setMap(map);
            var creatGoAnimation1=goAnimationManager.createGOAnimation(SuperMap.Plot.GOAnimationType.ANIMATION_SCALE,"比例动画",dotSymbol);
            var creatGoAnimation2=goAnimationManager.createGOAnimation(SuperMap.Plot.GOAnimationType.ANIMATION_SHOW,"显隐动画",dotSymbol);
            goAnimationManager.goAnimations=[creatGoAnimation1,creatGoAnimation2];
...
asyncTest("testGOAnimationManager_removeGOAnimationByName", function () {
    var libID = 421, code2 = 10200, locationPoints = [new SuperMap.Geometry.Point(20, 30)];
    var map, layer, plottingLayer, dotSymbol;
    map = new SuperMap.Map("map");
    layer = new SuperMap.Layer.TiledDynamicRESTLayer("World", GlobeParameter.WorldURL, null, {maxResolution: "auto"});
...
asyncTest("testGOAnimationManager_removeGOAnimation", function () {
    var libID = 421, code2 = 10200, locationPoints = [new SuperMap.Geometry.Point(20, 30)];
    var map, layer, plottingLayer, dotSymbol;
    map = new SuperMap.Map("map");
    layer = new SuperMap.Layer.TiledDynamicRESTLayer("World", GlobeParameter.WorldURL, null, {maxResolution: "auto"});
...
asyncTest("testGOAnimationManager_execute", function () {
    var libID = 421, code2 = 10200, locationPoints = [new SuperMap.Geometry.Point(20, 30)];
    var map, layer, plottingLayer, dotSymbol;
    map = new SuperMap.Map("map");
    layer = new SuperMap.Layer.TiledDynamicRESTLayer("World", GlobeParameter.WorldURL, null, {maxResolution: "auto"});
    ...
    setTimeout(function () {
        try{
            ...
            var flag=goAnimationManager.execute();
            ok(flag === true, "function:execute");
            start();
        } catch(exception){
            ok(false, "exception occcurs,message is:" + exception.message);
            start();
...
asyncTest("testGOAnimationManager_play", function () {
    var libID = 421, code2 = 10200, locationPoints = [new SuperMap.Geometry.Point(20, 30)];
    var map, layer, plottingLayer, dotSymbol;
    map = new SuperMap.Map("map");
    layer = new SuperMap.Layer.TiledDynamicRESTLayer("World", GlobeParameter.WorldURL, null, {maxResolution: "auto"});
...
asyncTest("testGOAnimationManager_stop", function () {
    var libID = 421, code2 = 10200, locationPoints = [new SuperMap.Geometry.Point(20, 30)];
    var map, layer, plottingLayer, dotSymbol;
    map = new SuperMap.Map("map");
    layer = new SuperMap.Layer.TiledDynamicRESTLayer("World", GlobeParameter.WorldURL, null, {maxResolution: "auto"});
...
asyncTest("testGOAnimationManager_pause", function () {
    var libID = 421, code2 = 10200, locationPoints = [new SuperMap.Geometry.Point(20, 30)];
    var map, layer, plottingLayer, dotSymbol;
    map = new SuperMap.Map("map");
    layer = new SuperMap.Layer.TiledDynamicRESTLayer("World", GlobeParameter.WorldURL, null, {maxResolution: "auto"});
...
asyncTest("testGOAnimationManager_reset", function () {
    var libID = 421, code2 = 10200, locationPoints = [new SuperMap.Geometry.Point(20, 30)];
    var map, layer, plottingLayer, dotSymbol;
    map = new SuperMap.Map("map");
    layer = new SuperMap.Layer.TiledDynamicRESTLayer("World", GlobeParameter.WorldURL, null, {maxResolution: "auto"});
...
asyncTest("testGOAnimationManager_createGOAnimationByType", function () {
    var libID = 421, code2 = 10200, locationPoints = [new SuperMap.Geometry.Point(20, 30)];
    var map, layer, plottingLayer, dotSymbol;
    map = new SuperMap.Map("map");
    layer = new SuperMap.Layer.TiledDynamicRESTLayer("World", GlobeParameter.WorldURL, null, {maxResolution: "auto"});
    ...
    setTimeout(function () {
        try{
            var goAnimationManager=new SuperMap.Plot.GOAnimationManager();
            goAnimationManager.setMap(map);
            var creatGoAnimation=goAnimationManager.createGOAnimationByType(SuperMap.Plot.GOAnimationType.ANIMATION_SCALE,"比例动画");
