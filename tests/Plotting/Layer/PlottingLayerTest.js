...
test("testPlottingLayer_drawFeature", function () {
    expect(1);
    var name = "PlottingLayer";
    var style = {
        strokeColor: "#339933"
    ...
    equal(pointFeature.style, style1, "function:drawFeature,测试与矢量要素的样式一致");
});
...
asyncTest("testPlottingLayer_createSymbol", function () {
    ...
    function addLayer() {
        ...
        plottingLayer.createSymbol(libID, code,locationPoints, function (evt) {
            feature = evt.feature;
        });
    }
    setTimeout(function () {
...
asyncTest("testPlottingLayer_createSymbolWC", function () {
    ...
    function addLayer() {
        map.addLayers([layer, plottingLayer]);
        map.setCenter(new SuperMap.LonLat(0, 0), 0);
        plottingLayer.createSymbolWC(libID, code,inputPoints, function (evt) {
            feature = evt.feature;
        });
    }
    setTimeout(function () {
...
asyncTest("testPlottingLayer_createText", function () {
    ...
    function addLayer() {
        ...
        plottingLayer.createText("createText", locationPoints, {}, function (evt) {
            feature = evt.feature;
        });
    }
    setTimeout(function () {
...
asyncTest("testPlottingLayer_createTextWC", function () {
    ...
    function addLayer() {
        ...
        plottingLayer.createSymbolWC(libID, code, inputPoints);
        var locationPoints = new SuperMap.Geometry.Point(20, 30);
        plottingLayer.createTextWC("createTextWC", locationPoints, {}, function (evt) {
            feature = evt.feature;
        });
    }
