...
test("TestFromGeometry_Polygon2",function(){
    ...
    equal(geometryConvert.components[0].components[0].components[0].x,point4.x,"geometryConvert.components[0].components[0].x");
    equal(geometryConvert.components[0].components[0].components[0].y,point4.y,"geometryConvert.components[0].components[0].y");
    equal(geometryConvert.components[0].components[0].components[1].x,point5.x,"geometryConvert.components[0].components[1].x");
    equal(geometryConvert.components[0].components[0].components[1].y,point5.y,"geometryConvert.components[0].components[1].y");
    equal(geometryConvert.components[0].components[0].components[2].x,point6.x,"geometryConvert.components[0].components[2].x");
    equal(geometryConvert.components[0].components[0].components[2].y,point6.y,"geometryConvert.components[0].components[2].y");
    equal(geometryConvert.components[0].components[0].components[3].x,point4.x,"geometryConvert.components[0].components[2].x");
    equal(geometryConvert.components[0].components[0].components[3].y,point4.y,"geometryConvert.components[0].components[2].y");

    equal(geometryConvert.components[1].components[0].components[0].x,point1.x,"geometryConvert.components[1].components[0].x");
    equal(geometryConvert.components[1].components[0].components[0].y,point1.y,"geometryConvert.components[1].components[0].y");
    equal(geometryConvert.components[1].components[0].components[1].x,point2.x,"geometryConvert.components[1].components[1].x");
    equal(geometryConvert.components[1].components[0].components[1].y,point2.y,"geometryConvert.components[1].components[1].y");
    equal(geometryConvert.components[1].components[0].components[2].x,point3.x,"geometryConvert.components[1].components[2].x");
    equal(geometryConvert.components[1].components[0].components[2].y,point3.y,"geometryConvert.components[1].components[2].y");
    equal(geometryConvert.components[1].components[0].components[3].x,point1.x,"geometryConvert.components[1].components[0].x");
    equal(geometryConvert.components[1].components[0].components[3].y,point1.y,"geometryConvert.components[1].components[0].y");
